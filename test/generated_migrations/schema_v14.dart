...
class Canvases extends Table with TableInfo {
  ...
  late final GeneratedColumn<int> rotationLocked = GeneratedColumn<int>(
    'rotation_locked',
    aliasedName,
    false,
    type: DriftSqlType.int,
    requiredDuringInsert: false,
    $customConstraints: 'NOT NULL DEFAULT 0 CHECK (rotation_locked IN (0, 1))',
    defaultValue: const CustomExpression('0'),
  );
  ...
  late final GeneratedColumn<int> canvasBackgroundColor = GeneratedColumn<int>(
    ...
    type: DriftSqlType.int,
    requiredDuringInsert: false,
    $customConstraints: 'NOT NULL DEFAULT 4279706417',
    defaultValue: const CustomExpression('4279706417'),
  );
  ...
  late final GeneratedColumn<double> gridSpacing = GeneratedColumn<double>(
    ...
    type: DriftSqlType.double,
    requiredDuringInsert: false,
    $customConstraints: 'NOT NULL DEFAULT 48.0',
    defaultValue: const CustomExpression('48.0'),
  );
  late final GeneratedColumn<double> gridOpacity = GeneratedColumn<double>(
    ...
    type: DriftSqlType.double,
    requiredDuringInsert: false,
    $customConstraints: 'NOT NULL DEFAULT 0.14',
    defaultValue: const CustomExpression('0.14'),
  );
  ...
  late final GeneratedColumn<int> paperTexture = GeneratedColumn<int>(
    'paper_texture',
    aliasedName,
    false,
    type: DriftSqlType.int,
  ...
  late final GeneratedColumn<double> paperTextureOpacity =
      GeneratedColumn<double>(
        ...
        type: DriftSqlType.double,
        requiredDuringInsert: false,
        $customConstraints: 'NOT NULL DEFAULT 0.06',
        defaultValue: const CustomExpression('0.06'),
      );
  ...
  late final GeneratedColumn<int> activePenTool = GeneratedColumn<int>(
    'active_pen_tool',
    aliasedName,
    false,
    type: DriftSqlType.int,
  ...
  late final GeneratedColumn<int> pressureEnabled = GeneratedColumn<int>(
    'pressure_enabled',
    aliasedName,
    false,
    type: DriftSqlType.int,
    requiredDuringInsert: false,
    $customConstraints: 'NOT NULL DEFAULT 1 CHECK (pressure_enabled IN (0, 1))',
...
class CanvasLayers extends Table with TableInfo {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  CanvasLayers(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<String> id = GeneratedColumn<String>(
    'id',
    aliasedName,
    false,
  ...
  late final GeneratedColumn<int> locked = GeneratedColumn<int>(
    ...
    type: DriftSqlType.int,
    requiredDuringInsert: false,
    $customConstraints: 'NOT NULL DEFAULT 0 CHECK (locked IN (0, 1))',
    defaultValue: const CustomExpression('0'),
  );
  ...
  late final GeneratedColumn<String> blendMode = GeneratedColumn<String>(
    ...
    type: DriftSqlType.string,
    requiredDuringInsert: false,
    $customConstraints: 'NOT NULL DEFAULT \'srcOver\'',
    defaultValue: const CustomExpression('\'srcOver\''),
  );
  ...
  @override
  CanvasLayers createAlias(String alias) {
    return CanvasLayers(attachedDatabase, alias);
  }
...
class CanvasBookmarks extends Table with TableInfo {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  CanvasBookmarks(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<String> canvasId = GeneratedColumn<String>(
    'canvas_id',
    aliasedName,
    false,
  ...
  @override
  CanvasBookmarks createAlias(String alias) {
    return CanvasBookmarks(attachedDatabase, alias);
  }

  @override
  List<String> get customConstraints => const ['PRIMARY KEY(canvas_id, name)'];
  @override
  bool get dontWriteConstraints => true;
}
...
class CanvasElements extends Table with TableInfo {
  ...
  late final GeneratedColumn<String> layerId = GeneratedColumn<String>(
    ...
    type: DriftSqlType.string,
    requiredDuringInsert: false,
    $customConstraints: 'NULL REFERENCES canvas_layers(id)ON DELETE SET NULL',
  );
  late final GeneratedColumn<int> kind = GeneratedColumn<int>(
    'kind',
    aliasedName,
...
class CanvasTexts extends Table with TableInfo {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  CanvasTexts(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<String> elementId = GeneratedColumn<String>(
    'element_id',
    aliasedName,
    false,
  ...
  @override
  CanvasTexts createAlias(String alias) {
    return CanvasTexts(attachedDatabase, alias);
  }
...
class CanvasShapes extends Table with TableInfo {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  CanvasShapes(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<String> elementId = GeneratedColumn<String>(
    'element_id',
    aliasedName,
    false,
  ...
  late final GeneratedColumn<int> arrowLegacy = GeneratedColumn<int>(
    'arrow_legacy',
    aliasedName,
    false,
    type: DriftSqlType.int,
    requiredDuringInsert: false,
    $customConstraints: 'NOT NULL DEFAULT 1 CHECK (arrow_legacy IN (0, 1))',
    defaultValue: const CustomExpression('1'),
  );
  @override
  List<GeneratedColumn> get $columns => [
  ...
  @override
  CanvasShapes createAlias(String alias) {
    return CanvasShapes(attachedDatabase, alias);
  }
...
class AppSettings extends Table with TableInfo {
  ...
  late final GeneratedColumn<int> accentColor = GeneratedColumn<int>(
    ...
    type: DriftSqlType.int,
    requiredDuringInsert: false,
    $customConstraints: 'NOT NULL DEFAULT 4293441611',
    defaultValue: const CustomExpression('4293441611'),
  );
  late final GeneratedColumn<int> backgroundColor = GeneratedColumn<int>(
    ...
    type: DriftSqlType.int,
    requiredDuringInsert: false,
    $customConstraints: 'NOT NULL DEFAULT 4279374354',
    defaultValue: const CustomExpression('4279374354'),
  );
  late final GeneratedColumn<String> inkPaletteJson = GeneratedColumn<String>(
    ...
    requiredDuringInsert: false,
    $customConstraints:
        'NOT NULL DEFAULT \'[4294922129,4291316008,4281771008,4276755455,4294967295,4279318560]\'',
    defaultValue: const CustomExpression(
...
class DatabaseAtV14 extends GeneratedDatabase {
  ...
  late final CanvasLayers canvasLayers = CanvasLayers(this);
  late final CanvasBookmarks canvasBookmarks = CanvasBookmarks(this);
  ...
  late final CanvasTexts canvasTexts = CanvasTexts(this);
  late final CanvasShapes canvasShapes = CanvasShapes(this);
